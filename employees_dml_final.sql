...
-- ЗАДАНИЕ 3: Удалить сотрудника с ID = 202
SELECT * FROM employees WHERE emp_no = 202;
DELETE FROM employees WHERE emp_no = 202;
SELECT * FROM employees WHERE emp_no = 202;

-- ЗАДАНИЕ 4: Добавить зарплату сотруднику с ID = 103
...
-- ЗАДАНИЕ 5: Обновить должность сотрудника с ID = 104 на 'Senior Developer'
...
-- ЗАДАНИЕ 6: Удалить все записи о зарплатах для сотрудника с ID = 105
...
-- ЗАДАНИЕ 7: Добавить новый департамент в таблицу departments
...
-- ЗАДАНИЕ 10: Добавить нескольких сотрудников одним запросом
